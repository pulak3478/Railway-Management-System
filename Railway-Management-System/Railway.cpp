...
int main()
{
    ...
    printf("\t\t\tPresented By - Md.Israkul Islam , Pulak Islam , Arpon Bhattacharjee\n");
    printf("\t\t\t\t----------------------------------------\n");
    system("Color E4");
    destinations();
    trainDetails();
   while(1)
   {
    ...
    printf("\t\t## Admin Login Password is 207 ##");
    ...
    else if(ch==4)
    {
        ...
        int i=0,j=0,c;
        printf("\n\t\tClass: (Press 1::First class  Press 2::Second class  Press 3::General class)\n\t\t");
        scanf("%d",&c);
        if(c==1)
            {
                  while(i<10)
                ...
                else
                {
                    for(i=3;i<temp->total_seat;i++)
                    {
                        for(j=0;j<10;j++)
                        {
                         if(temp->bogies_seat[i][j]!=0){newnode->bogie_number=i;
                         newnode->seat_number=j;temp->bogies_seat[i][j]--;
                         temp->General_class_total_seats--;
                         temp->total_seat--;
                         flag2=0;break;}
                        }
                        if(flag2==0)break;
           ...
           if(strcmp(temp->name,newnode->name)==0 && temp->age==newnode->age)
           {
               ...
               while(st!=0)
               {
                 if(strcmp(st->name,temp->trainName)==0)
                 {
                   ...
                   else{st->General_class_total_seats++;}
                   st->total_seat++;
                 }
                 st=pop();
               }
...
void trainDetails()   //train detailsssssssssssssssssssssssssssssssssss
{
    ...
    n1->General_class_total_seats=40;
    for(i=0;i<5;i++)
    {
       for(j=0;j<10;j++)
       {
    ...
    n2->General_class_total_seats=60;
    for(i=0;i<6;i++)
    {
       for(j=0;j<10;j++)
       {
    ...
    n3->General_class_total_seats=80;
    for(i=0;i<7;i++)
    {
       for(j=0;j<10;j++)
       {
    ...
    n4->General_class_total_seats=80;
    for(i=0;i<8;i++)
    {
       for(j=0;j<10;j++)
       {
...
void printTrainDetails()
{
    ...
    while(s!=0)
    {
        ...
        printf("\t\tGeneral class total seats: %d\n",s->General_class_total_seats);
...
void cancelTicket(queue* newnode)
{
 ...
 void availableTrains(queue *newnode)
 {
     ...
     while(temp!=0)
     {
         ...
         {
             printf("\n\t\tTrain Name: %s   Starting Time: %s   Total Seats: %d\n\t\tFirst Class Seats: %d   Second Class Seats: %d   General Class Seats: %d\n\t\t",
                    temp->name,temp->time,temp->total_seat,temp->first_class_total_seats,temp->second_class_total_seats,temp->General_class_total_seats);
         }
         temp=pop();
     }
 }
